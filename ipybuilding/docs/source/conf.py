...
# -*- coding: utf-8 -*-
#
# ipybuilding documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipybuilding', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipybuildingdoc'
...
latex_documents = [
    (master_doc, 'ipybuilding.tex', 'ipybuilding Documentation',
     'victor férat, jonathan chambers', 'manual'),
]
